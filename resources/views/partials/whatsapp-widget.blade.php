...
@if (!empty($waDigits))
  <div
    id="waWidget"
    class="fixed bottom-5 left-5 z-[95] flex flex-row items-end gap-2"
  ...
  >
    <div class="relative shrink-0">
      ...
      <div
        id="waPopup"
        class="pointer-events-none absolute bottom-[calc(100%+0.5rem)] left-0 w-[min(20.5rem,calc(100vw-2.5rem))] translate-y-2 opacity-0 transition-all duration-200"
        role="dialog"
    ...
    <span class="pointer-events-none select-none pb-1 text-sm font-bold tracking-tight text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.85)] max-w-[5.5rem] leading-tight sm:max-w-none">
      {{ __('Chat Us') }}
    </span>
  </div>
